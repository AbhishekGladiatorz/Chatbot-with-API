...
import urlscan
import ipscan
import filefinderprogram
import filereader
import urlscandetail
def Commands(message):
	...
	try:
		...
		elif message[0] == "!urlscandetail":
			if message[1]:
				try:
					urlscandetail.urlscandetail1(message[1])
				except:
					print("Check url please")
			else:
				print("Bad syntax")
		...
		elif message[0] == "!filefinder":
			try:
				filefinderprogram.file_finder()
			except:
				print("Hmm,there is a problem")


		elif message[0] == "!filereader":
			try:

				filereader.file_read_from_tail()
			except:
				print("Hmm,there is a problem")
